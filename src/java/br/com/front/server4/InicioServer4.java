...
public class InicioServer4 {
    private JPanel jpanelServer4View;
    ...
    public InicioServer4() {
        ...
        //button
        btnLimpar.addActionListener(new InicioServer4.ClearBtnClicked());
        btnBaixar.addActionListener(new InicioServer4.BaixarBtnClicked());
    }
    ...
    public static void main(String[] args) {
        layoutNimbus();
        JFrame frame = new JFrame("InicioServer4");
        frame.setTitle("Tela do SERVIDOR - 4");
        ImageIcon imagemTituloJanela = new ImageIcon("br/com/front/servidor.png");
        frame.setIconImage(imagemTituloJanela.getImage());
        frame.setContentPane(new InicioServer4().jpanelServer4View);
